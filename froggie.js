...
async function addWeatherTiles(widget,webview,num) {
  ...
  var res = {
    ...
    img: document.querySelector('.D34Qd > tile-container:nth-child(3) > g-inner-card:nth-child(1) > div:nth-child(1) > tile-img:nth-child(3) > g-img:nth-child(1) > img:nth-child(1)').src
  }
  res
  `
